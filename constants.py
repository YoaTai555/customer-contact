...
SEARCH_WIKI_INFO_TOOL_NAME = "search_wiki_tool"
SEARCH_WIKI_INFO_TOOL_DESCRIPTION = "一般的な用語や単語に関する質問で、Wikipedia検索が必要と判断した場合に使う"
...
SYSTEM_PROMPT_NOTICE_SLACK = """
    ...
    --------------------
    【メンション先の選定理由】
    {name_list[0]}さんは、●●の経験があり、過去に類似の問い合わせ対応を行っているため。●●の専門的な知識を持っています。
    {name_list[1]}さんは、●●のスキルを持っており、過去の問い合わせ対応履歴からも、●●に関する問い合わせに対応した実績があります。
    --------------------
